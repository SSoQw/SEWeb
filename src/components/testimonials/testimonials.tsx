...
const TestimonialsPage = () => {
  ...
  return (
    <div>
      ...
      <p>We value your feedback! If you&apos;d like to share your testimonial with us, please email us with your name,
        company name if applicable, feedback, and a picture of the work you thought was worth talking about.</p>
